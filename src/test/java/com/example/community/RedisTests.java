...
public class RedisTests {
    ...
    public void testSortedSets(){
        ...
        redisTemplate.opsForZSet().add(redisKey,"dd",20);

        System.out.println(redisTemplate.opsForZSet().zCard(redisKey));
        System.out.println(redisTemplate.opsForZSet().score(redisKey, "bb"));
        System.out.println(redisTemplate.opsForZSet().rank(redisKey, "bb"));
    ...
    public void testHyperLogLog(){
        ...
        for (int i = 1; i <= 100000 ; i++) {
            int val = (int)(Math.random() * 100000 + 1);
            redisTemplate.opsForHyperLogLog().add(redisKey,val);
        }
